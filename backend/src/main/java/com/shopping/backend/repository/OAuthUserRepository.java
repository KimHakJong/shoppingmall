...
public interface OAuthUserRepository extends JpaRepository<OAuthUser, Long> {
     ...
     * @return OAuth 사용자 정보 (Optional)
     */
    Optional<OAuthUser> findByUserIdAndProvider(String userId, String provider);
     ...
     * @return OAuth 사용자 목록
     */
    List<OAuthUser> findByProvider(String provider);
     ...
     */
    List<OAuthUser> findByProviderAndIsActive(String provider, String isActive);
    ...
    List<OAuthUser> findExpiredAccessTokens(@Param("currentTime") java.time.LocalDateTime currentTime);
